                        ...
                        <div class="position-relative mt-4">
                            <b-table responsive
                                ...
                                <template v-slot:cell(opsi)="data">
                                    <router-link :to="'manajemen-user/edit/' + data.item.id" v-b-tooltip title="Edit data" class="btn btn-xs btn-info"><eva-icon name="edit-2-outline"></eva-icon></router-link>
...
<script>
    ...
    import ModalResetPassword from '@/components/Backend/Sudo/ManajemenUser/Reset'
    export default {
        ...
        data() {
            return {
                ...
                tableColumns: [
                    ...
                    { key: 'kecamatan', label: 'Kecamatan', tdClass: 'description' },
        ...
        methods: {
            providerTable() {
                return [
                    { id: 1, nama: 'Halo', username: 'halo', kecamatan: 'Balen' },
                    { id: 2, nama: 'Admin', username: 'admin', kecamatan: 'Balen' },
                    { id: 3, nama: 'Danu', username: 'danu', kecamatan: 'Balen' },
                    { id: 4, nama: 'Dani', username: 'dani', kecamatan: 'Balen' },
                ]
            },
            resetPassword(id) {
